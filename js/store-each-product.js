...
const productInfoDescription = document.querySelector(".product__description-text");
...
if (productName && productInfoTitle && productInfoDescription && productInfoPrice && mainProductPhoto) {
  ...
  console.error("No product specified in localStorage or missing elements on page");
}
